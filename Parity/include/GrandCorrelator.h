 ...
 */
class GrandCorrelator : public VQwDataHandler, public MQwDataHandlerCloneable<GrandCorrelator>
{
 public:
...
//========================================================
 ...
 public:
  ...
  friend GrandCorrelator operator+(GrandCorrelator lhs,  // passing lhs by value helps optimize chained a+b+c
                   const GrandCorrelator& rhs) // otherwise, both parameters may be const references
  {
...
inline std::ostream& operator<< (std::ostream& stream, const GrandCorrelator& h)
{
